...
public final class MISCTWFStructurePieceTypes {
	...
	public static final StructurePieceType STAIRCASE_TYPE = Registry.register(Registry.STRUCTURE_PIECE, "boss_lair_staircase", BossLairPieces.StaircasePiece::new);
