...
public class ZombiePolarBearModel<T extends ZombiePolarBearEntity> extends QuadrupedModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		root.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 19).addBox(-5.0F, -13.0F, -7.0F, 14.0F, 14.0F, 11.0F).texOffs(39, 0).addBox(-4.0F, -25.0F, -7.0F, 12.0F, 12.0F, 10.0F), PartPose.offsetAndRotation(-2.0F, 9.0F, 12.0F, Mth.HALF_PI, 0.0F, 0.0F));
